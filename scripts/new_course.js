...
const createACourse = async (event) => {
    ...
    try {
        ...
        //make a fetch (POST) request to create a course in the API
        ...
        //put the course in the console
        console.log(newCourse, "this should show up if I created a new course");
